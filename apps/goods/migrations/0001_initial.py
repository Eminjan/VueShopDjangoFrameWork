# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-05-13 02:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category_type', models.CharField(choices=[(1, '一级类目'), (2, '二级类目'), (3, '三级类目')], help_text='类别名', max_length=30, verbose_name='类别名')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imgae', models.ImageField(upload_to='brand/images')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
            ],
        ),
        migrations.CreateModel(
